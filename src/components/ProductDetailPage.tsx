...
// import MAN_CHART from "../assets/men-chart.jpeg";
// import WOMEN_CHART from "../assets/women-chart.jpeg";
...
//   onLogoClick?: () => void; // Add this prop for logo click
//   cartCount?: number;
//   onCartClick?: () => void;
// }
...
//   // Detect gender from category when product loads
//   useEffect(() => {
//     if (product) {
//       const categoryGender = detectGenderFromCategory(product.category);
//       setDetectedGender(categoryGender);
//     } else {
//       setDetectedGender(gender);
//     }
//   }, [product, gender]);

//   // Category se gender detect karne ka function
//   const detectGenderFromCategory = (category: string) => {
//     if (!category) return gender;
    
//     const categoryLower = category.toLowerCase();
//     if (categoryLower.includes('women') || categoryLower.includes('female') || categoryLower === 'women') {
//       return 'women';
//     } else if (categoryLower.includes('men') || categoryLower.includes('male') || categoryLower === 'men') {
//       return 'men';
//     }
//     return gender;
//   };
...
//         <Navigation 
//   mode="light" 
//   // Temporary: या तो comment out कर दें
//   // onCollectionClick={onCollectionClick} 
//   // onOurStoryClick={onOurStoryClick} 
//   // onCraftsmanshipClick={onCraftsmanshipClick} 
  
//   // या default functions use करें:
//   onCollectionClick={onCollectionClick || (() => window.location.hash = 'collections')}
//   onOurStoryClick={onOurStoryClick || (() => console.log('Our Story clicked'))}
//   onCraftsmanshipClick={onCraftsmanshipClick || (() => window.location.hash = 'craftsmanship')}
//   cartCount={cartCount} 
//   onCartClick={onCartClick}
...
//                       Size Guide ({detectedGender === 'women' ? 'Women' : 'Men'})
//                     </h3>
                    
//                     {/* Conditionally render size chart based on gender */}
//                     {detectedGender === 'women' ? (
//                       <div>
//                         {/* Women Size Chart */}
//                         <img 
//                           src={WOMEN_CHART} 
//                           alt="Women Size Guide Chart"
//                           className="w-full h-auto max-w-md mx-auto rounded-lg shadow-sm"
//                         />
//                         <div className="mt-4 space-y-2">
//                           <h4 className="text-sm font-semibold text-[#2c1810]">Women's Sizing Tips:</h4>
//                           <ul className="text-xs text-[#2c1810]/70 space-y-1">
//                             <li>• For tops, measure your bust at the fullest point</li>
//                             <li>• For bottoms, measure your waist and hips</li>
...
//                         <img 
//                           src={MAN_CHART} 
//                           alt="Men Size Guide Chart"
//                           className="w-full h-auto max-w-md mx-auto rounded-lg shadow-sm"
//                         />
//                         <div className="mt-4 space-y-2">
//                           <h4 className="text-sm font-semibold text-[#2c1810]">Men's Sizing Tips:</h4>
//                           <ul className="text-xs text-[#2c1810]/70 space-y-1">
//                             <li>• For shirts, measure around the fullest part of your chest</li>
//                             <li>• For pants, measure your natural waist</li>
//                             <li>• Traditional fits may be slightly looser</li>
//                           </ul>
//                         </div>
//                       </div>
//                     )}
...
//                     <div className="mt-6 pt-4 border-t border-[#2c1810]/10">
//                       <h4 className="text-sm font-semibold text-[#2c1810] mb-2">General Notes:</h4>
//                       <ul className="text-xs text-[#2c1810]/70 space-y-1">
//                         <li>• All measurements are in inches/centimeters</li>
//                         <li>• For custom sizing, please contact our customer service</li>
//                         <li>• Size charts may vary slightly by collection</li>
//                       </ul>
//                     </div>
//                   </div>
//                 )}
...
//                   Each Sohwais piece is handcrafted to order. Please allow 3 to 4 days for careful creation before dispatch.

// We offer free shipping across India. Worldwide shipping is available and will be charged at checkout.

// Once your order is shipped, you will receive a confirmation via email and WhatsApp with your tracking details. Delivery timelines after dispatch typically range from 5 to 7 days, depending on your location.

// Feel free to reach out to us on support@sohwais.com
//                 </p>
//               </div>
//             )}
//           </div>
...
//           onOurStoryClick={onOurStoryClick}
//           onCraftsmanshipClick={onCraftsmanshipClick}
//           onHomeClick={handleLogoClick} // Use the same handler for home
//         />
//       </ExperienceFooterWrapper>
//     </div>
//   );
...
import { Link, useNavigate, useParams } from 'react-router-dom'; // ✅ Added React Router imports
import { Navigation } from './Navigation';
import { Footer } from './Footer';
import { ExperienceFooterWrapper } from './ExperienceFooterWrapper';
import MAN_CHART from "../assets/men-chart.jpeg";
...
export function ProductDetailPage({ 
  ...
  const handleBack = () => {
    if (onBack) {
      ...
      navigate(-1); // Default: go back in browser history
    }
  };
