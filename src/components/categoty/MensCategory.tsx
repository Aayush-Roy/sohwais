...
const MensCategory = () => {
  ...
  useEffect(() => {
    ...
    const possibleUrls = [
      ...
      'https://api.sohwais.com/category/Men',
      'http://localhost:3000/api/category/Men',
      'http://localhost:5000/api/category/Men',
      '/api/category/Men' // Relative URL (proxy)
    ];

    // Use the first non-empty URL
    const url = possibleUrls.find(u => u) || 'https://api.sohwais.com/category/Men';
    setApiUrl(url);
